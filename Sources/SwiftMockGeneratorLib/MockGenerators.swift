...
public class StubGenerator: MockGeneratorProtocol {
    ...
    public func generateMock(for element: CodeElement, annotation: MockAnnotation) throws -> String {
        ...
        case .struct(let structElement):
            return generateStructStub(structElement, annotation: annotation)
    ...
    // MARK: - Struct Stub Generation
    
    private func generateStructStub(_ structElement: StructElement, annotation: MockAnnotation) -> String {
        var output = [String]()
        
        // Header comment
        output.append("// MARK: - Generated Stub for \(structElement.name)")
        output.append("// Generated by SwiftMockGenerator")
        output.append("")
        
        // Struct declaration
        let structName = "\(structElement.name)Stub"
        ...
        for method in structElement.methods {
            output.append("    \(generateMethodStub(method, isMutable: method.isMutating))")
            output.append("")
        }
